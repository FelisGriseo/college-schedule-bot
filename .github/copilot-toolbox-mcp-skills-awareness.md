...
_Generated: 2026-09-23T15:35:45.932Z_
...
Workspace `mcp.json` _(folder: HPFK)_

- **d:\VS Studio\HPFK\.vscode\mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\MSIPe\AppData\Roaming\Code\User\mcp.json** — _File missing_
